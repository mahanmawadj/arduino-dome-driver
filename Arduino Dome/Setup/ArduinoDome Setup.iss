...
; Generated by Mahan on 2016-09-25 (UTC)
;
[Setup]
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ArduinoDome.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ArduinoDome.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ArduinoDome.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ArduinoDome.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ArduinoDome.dll"""; Flags: runhidden 64bit; Check: IsWin64
